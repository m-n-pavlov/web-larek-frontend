...
// Функция преобразует число в строку и, если в нём 5 или более цифр,
// форматирует её, вставляя пробелы как разделители тысяч каждые три цифры,
// иначе возвращает простую строку числа
